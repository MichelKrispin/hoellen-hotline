...
- Der Repository-Basispfad wird zusätzlich durch `VITE_BASE=/hoellen-hotline/ npm run build` geprüft. Der Build erzeugt `index.html` mit relativen Asset-URLs unter diesem Basispfad.
